...
public class FileUtils {
	 ...
	 */
	public boolean outputFile(Context context, String fileName, ArrayList<String> listUII) {
		...
		try {
			if (listUII.size() > 0) {
				...
				for (int i = 0; i < listUII.size(); i++) {
					bufferedWriterLogResult.append(String.format("%s", listUII.get(i) + ","));
